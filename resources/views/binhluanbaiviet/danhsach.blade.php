...
<div class="card">
    ...
    <div class="card-body table-responsive">
        <p><a href="{{ route('binhluanbaiviet.them') }}" class="btn btn-info"><i class="fa-light fa-plus"></i> Thêm mới</a></p>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:justify">
                        <span class="d-block fw-bold text-primary"><a href="{{ route('binhluanbaiviet.sua', ['id' => $value->id]) }}">{{ $value->BaiViet->tieude }}</a></span>
                    ...
                    <td class="text-center" title="Trạng thái kiểm duyệt">
                        <a href="{{ route('binhluanbaiviet.kiemduyet', ['id' => $value->id]) }}">
                    ...
                    <td class="text-center" title="Trạng thái hiển thị">
                        <a href="{{ route('binhluanbaiviet.kichhoat', ['id' => $value->id]) }}">
                            @if($value->kichhoat == 1)
                    ...
                    <td class="text-center">
                        <a href="{{ route('binhluanbaiviet.sua', ['id' => $value->id]) }}">
                            <i class="fa-light fa-lg fa-edit"></i>
                        </a>
                    </td>
                    <td class="text-center">
                        <a href="{{ route('binhluanbaiviet.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có muốn xóa bình luận của bài viết {{ $value->BaiViet->tieude }} không?')">
